...
public class hora_calculos {
	...
	public static void main(String[] args) {
		...
		LocalDateTime pastWeekLocalDate = d05.minusDays(7);  //horas em java sao imutaveis, voce precisa crair 1 nova sempre que qusier mudar o valor
